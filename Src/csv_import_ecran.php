...
$required_fields_monitor = [
    'serial', 'manufacturer', 'model', 'size_inch', 'resolution',
    'connector', 'attached_to'
];

$conn = mysqli_connect("localhost", "inkware", "!sae2025!", "INVENTORY");

$target_table = "Monitors";
$fields_count = count($required_fields_monitor);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $fields_list = implode(', ', $required_fields_monitor);
